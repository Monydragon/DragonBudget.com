...
- The static site currently has 65 public HTML pages across product, guide, trust, demo, launch, support, feedback, release, and QA sections.
...
- Latest polish pass: budget-badge dragon PNG for the favicon, mascot, and advisor mark; one top navigation menu; no negative currency displays in calculator/demo results; and public copy cleaned of internal build labels.
