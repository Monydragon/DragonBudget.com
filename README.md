...
- Prompt implementation tracker: [docs/DragonBudget.com LLM Prompt Source.txt](</home/monydragon/Projects/Github/Web/DragonBudget.com/docs/DragonBudget.com LLM Prompt Source.txt>).
- The static site currently has 62 public HTML pages across product, guide, trust, demo, launch, and QA sections.
...
To publish on GitHub Pages, set Pages to deploy from the `main` branch and repository root. The root `CNAME` file is set for `DragonBudget.com`.
